...
helm.sh/chart: {{ include "renovate-server.chart" . }}
{{ include "renovate-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- define "renovate-server.webhookPort" -}}
{{- index (split ":" (default ":0" .Values.config.server.webhook.listen)) "_1" -}}
{{- end }}
